        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeviceConfigurationEntityDeviceId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SensorConfigurations_DeviceConfigurations_DeviceConfigurationEntityDeviceId",
                        column: x => x.DeviceConfigurationEntityDeviceId,
                        principalSchema: "climateMonitor",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Records_DeviceConfigurations_DeviceId",
                        column: x => x.DeviceId,
                        principalSchema: "climateMonitor",
                        principalTable: "DeviceConfigurations",
                        principalColumn: "DeviceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SensorConfigurations_DeviceConfigurationEntityDeviceId",
                schema: "climateMonitor",
                table: "SensorConfigurations",
                column: "DeviceConfigurationEntityDeviceId");
        }
